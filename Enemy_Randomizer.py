...
if (
    input(
        "    /\\                          /\\\n   /__\\     Welcome to the     /__\\\n  /\\  /\\    Botw Enemizer!    /\\  /\\\n /__\\/__\\                    /__\\/__\\\n\nPLEASE look at the README file before continuing!\n\nTo customize settings, type 'custom'. To use default setting, just press Enter: "
    )
    == "custom"
):
...
spawnableEnemy = [
    (
        "Enemy_Assassin_Shooter_Azito_Junior",
        {
            ...
            "DropTable": "Normal",
            "EquipItem1": "Weapon_Bow_040",
            "EquipItem2": "Default",
            "EquipItem3": "Default",
            "EquipItem4": "Default",
            "IsNearCreate": false,
            "LevelSensorMode": 1,
            "NearCreateAppearID": 0,
            "SharpWeaponJudgeType": 1,
            "TerritoryArea": 0.0,
        },
    ),
    (
        "Enemy_Assassin_Azito_Middle_DLC2",
        {
            "ArrowName": "NormalArrow",
            "DropTable": "Normal",
            "EquipItem1": "Weapon_Lsword_074",
            "EquipItem2": "Default",
            "EquipItem3": "Weapon_Sword_043",
            "EquipItem4": "Default",
            "IsNearCreate": false,
            "IsWatchKeeping": false,
            "LevelSensorMode": 1,
            "NearCreateAppearID": 0,
            "RotAngle": 0.0,
            "SharpWeaponJudgeType": 1,
    ...
    (
        "Enemy_Golem_Little_Fire",
        {
            ...
            "EquipItem3": "Default",
            "EquipItem4": "Default",
            "GolemSleepType": "SleepForward_A",
            "GolemWeakPointLocation": "Point_A",
            "IsNearCreate": false,
            "LevelSensorMode": 1,
    ...
    (
        "Enemy_Guardian_A",
        {
            "ChaseRange": 200,
            "DropTable": "Normal",
            "GuardianLegType0": "Guardian_A_Leg",
            "GuardianLegType1": "Guardian_A_Leg",
            "GuardianLegType2": "Guardian_A_Leg",
            "GuardianLegType3": "Guardian_A_Leg",
            "GuardianLegType4": "Guardian_A_Leg",
            "GuardianLegType5": "Guardian_A_Leg",
            "IsSuspended": true,
            "SharpWeaponJudgeType": 1,
        },
    ),
    ...
    (
        "Enemy_Guardian_Mini_Baby",
        {
            ...
            "EquipItem3": "Default",
            "EquipItem4": "Default",
            "IsAnnihilateDungeonEnemy": false,
            "IsNearCreate": false,
            "LevelSensorMode": 1,
            "NearCreateAppearID": 0,
            "SharpWeaponJudgeType": 0,
    ...
    (
        "Enemy_Guardian_Mini_Middle",
        {
            ...
            "BeamRange": 0,
            "DropTable": "Normal",
            "EquipItem1": "Weapon_Sword_014",
            "EquipItem2": "Weapon_Lsword_014",
            "EquipItem3": "Default",
            "EquipItem4": "Default",
            "IsAnnihilateDungeonEnemy": false,
            "IsNearCreate": false,
    ...
    (
        "Enemy_Guardian_Mini_Senior",
        {
            ...
            "BeamRange": 0,
            "DropTable": "Normal",
            "EquipItem1": "Weapon_Sword_015",
            "EquipItem2": "Weapon_Lsword_015",
            "EquipItem3": "Weapon_Spear_015",
            "EquipItem4": "Default",
            "IsAnnihilateDungeonEnemy": false,
            "IsNearCreate": false,
            "LevelSensorMode": 1,
    ...
    (
        ...
        {
            "ArrowName": "NormalArrow",
            "EquipItem1": "Weapon_Spear_034",
            "EquipItem3": "LizalfosPipe",
            "FortressEatPer": -1,
            "IsMimicry": false,
            "IsNearCreate": false,
            "IsWatchKeeping": true,
    ...
    (
        ...
        {
            "EquipItem1": "Weapon_Sword_029",
            "EquipItem2": "Weapon_Shield_026",
            "FortressEatPer": -1,
            "IsMimicry": false,
            "IsNearCreate": false,
            "IsWatchKeeping": false,
    ...
    (
        "Enemy_Lynel_Junior",
        {
            "ArrowName": "ElectricArrow",
            "EquipItem1": "Weapon_Lsword_016",
            "EquipItem3": "Weapon_Bow_009",
            "IsNearCreate": false,
            "LevelSensorMode": 1,
            "SharpWeaponJudgeType": 0,
            "TerritoryArea": 0,
    ...
    (
        ...
        {
            "ArrowName": "IceArrow",
            "EquipItem1": "Weapon_Lsword_017",
            "EquipItem3": "Weapon_Bow_026",
            "IsNearCreate": false,
            "LevelSensorMode": 1,
            "SharpWeaponJudgeType": 0,
            "TerritoryArea": 0,
    ...
    (
        ...
        {
            "ArrowName": "IceArrow",
            "EquipItem1": "Weapon_Lsword_018",
            "EquipItem3": "Weapon_Bow_032",
            "IsNearCreate": false,
            "LevelSensorMode": 1,
            "SharpWeaponJudgeType": 0,
            "TerritoryArea": 0,
    ...
    (
        ...
        {
            "EquipItem1": "Weapon_Sword_009",
            "EquipItem2": "Weapon_Shield_009",
            "FortressEatPer": -1,
            "IsNearCreate": false,
            "IsWatchKeeping": true,
            "LevelSensorMode": 1,
    ...
    (
        ...
        {
            "ArrowName": "NormalArrow",
            "CarryActorName": "OctObj_Grass_08",
            "DropTable": "Normal",
            "EquipItem1": "Default",
            "EquipItem2": "Default",
            "EquipItem3": "Default",
    ...
    (
        ...
        {
            "ArrowName": "NormalArrow",
            "CarryActorName": "OctObj_Grass_05",
            "DropTable": "Normal",
            "EquipItem1": "Default",
            "EquipItem2": "Default",
            "EquipItem3": "Default",
...
spawnableBoss = [
    (
        ...
        {
            "EquipItem3": "Weapon_Sword_001",
            "EquipItem4": "Weapon_Bow_001",
            "EquipItem5": "Weapon_Lsword_002",
            "GiantRoamType": 0,
            "IsNearCreate": false,
            "LevelSensorMode": 1,
            "SharpWeaponJudgeType": 0,
    ...
    (
        "Enemy_Giant_Middle",
        {
            "EquipItem3": "Weapon_Sword_001",
            "EquipItem4": "Weapon_Bow_001",
            "EquipItem5": "Weapon_Spear_002",
            "GiantArmor2": "GiantGreave_Wood_L",
            "GiantRoamType": 0,
            "IsNearCreate": false,
            "LevelSensorMode": 1,
            "SharpWeaponJudgeType": 0,
    ...
    (
        "Enemy_Giant_Senior",
        {
            "EquipItem3": "Weapon_Sword_024",
            "EquipItem4": "Weapon_Bow_036",
            "EquipItem5": "Weapon_Lsword_002",
            "GiantArmor2": "GiantGreave_Iron_L",
            "GiantRoamType": 0,
            "IsNearCreate": false,
            "LevelSensorMode": 1,
            "SharpWeaponJudgeType": 0,
    ...
    (
        "Enemy_Golem_Fire",
        {
            "GolemSleepType": "SleepForward_B",
            "GolemWeakPointLocation": "Point_B",
            "IsNearCreate": false,
            "LevelSensorMode": 1,
            "SharpWeaponJudgeType": 0,
            "TerritoryArea": 0,
    ...
    (
        ...
        {
            "GolemSleepType": "SleepForward_B",
            "GolemWeakPointLocation": "Point_C",
            "IsNearCreate": false,
            "LevelSensorMode": 1,
            "SharpWeaponJudgeType": 0,
            "TerritoryArea": 0,
    ...
    (
        "Enemy_SandwormR",
        {
            ...
            "DropTable": "Normal",
            "EquipItem1": "Default",
            "EquipItem2": "Weapon_Spear_021",
            "EquipItem3": "Weapon_Lsword_029",
            "EquipItem4": "Weapon_Spear_029",
            "EquipItem5": "Weapon_Sword_021",
            "EquipItem6": "Weapon_Spear_030",
            "IsNearCreate": false,
            "LevelSensorMode": 1,
            "SharpWeaponJudgeType": 1,
            "TerritoryArea": 0,
                ...
                for j in range(len(data["Objs"])):
                    ...
                    if newEnemy[0] in isInGround:
                        if "Guardian_C" in newEnemy[0]:
                            data["Objs"][j]["Translate"][1] = oead.F32(
                                float(data["Objs"][j]["Translate"][1]) + 7.0
                            )
                        data["Objs"][j]["Translate"][1] = oead.F32(
                            float(data["Objs"][j]["Translate"][1]) + 2.0
                        )
...
def randomizeEnemiesPack(subPath, subPath2, packNames):
    ...
    for pack in packNames:
        ...
        for file in sarc.get_files():
            nom = file.name
            if nom in [
                subPath2 + pack + "/" + pack + "_Static.smubin",
                subPath2 + pack + "/" + pack + "_Dynamic.smubin",
            ]:
                ...
                sarc_writer.files[nom] = oead.yaz0.compress(
                    oead.byml.to_binary(data, True)
                )
        if not isThereEnemy:
...
def copyValues(enemy, mapData, index):
    if "Guardian_A_Fixed" in mapData["Objs"][index]["UnitConfigName"]:
        mapData["Objs"][index]["Translate"][1] = oead.F32(
            float(mapData["Objs"][index]["Translate"][1]) + 2.5
        )
    if (
        "Golem" in enemy[0]
        and "Little" not in enemy[0]
        and enemy[0] != "Enemy_Golem_Fire_R"
    ):
        enemy[1]["GolemSleepType"] = random.choice(["SleepForward_B", "SleepForward_A"])
        enemy[1]["GolemWeakPointLocation"] = random.choice(
        ...
        if random.randint(0, 2) != 0:
            enemy[1]["GiantArmor1"] = random.choice(
                ["GiantGreave_Wood_R", "GiantGreave_Iron_R"]
            )
        if random.randint(0, 2) != 0:
            enemy[1]["GiantArmor2"] = random.choice(
                ["GiantGreave_Wood_L", "GiantGreave_Iron_L"]
            )
    ...
    if "Guardian_C" in mapData["Objs"][index]["UnitConfigName"]:
        mapData["Objs"][index]["Translate"][1] = oead.F32(
            float(mapData["Objs"][index]["Translate"][1]) + 30.0
        )
...
def randomizeWeapon(enemy, mapData, index):
    ...
    if enemy[0] in isMiniGuardian:
        ...
        if enemy[0] == "Enemy_Guardian_Mini_Senior":
            mapData["Objs"][index]["!Parameters"]["EquipItem1"] = random.choice(
                weaponChoices.pop(randint(0, len(weaponChoices) - 1))
            )
            mapData["Objs"][index]["!Parameters"]["EquipItem2"] = random.choice(
                weaponChoices.pop(randint(0, len(weaponChoices) - 1))
            )
            mapData["Objs"][index]["!Parameters"]["EquipItem3"] = random.choice(
                weaponChoices.pop(randint(0, len(weaponChoices) - 1))
            )
    ...
    # Lynel
        ...
        if alea == 0:
            ...
            mapData["Objs"][index]["!Parameters"]["EquipItem4"] = random.choice(
                tableShield
            )
        # Spear
        elif alea == 1:
    ...
    # Any Weapon
        ...
        if alea == 0:
            ...
            mapData["Objs"][index]["!Parameters"]["ArrowName"] = random.choice(
                tableArrow
            )
        else:
            mapData["Objs"][index]["!Parameters"]["EquipItem1"] = random.choice(
...
if hyrule:
    ...
    randomizeEnemies(
        "Enemy Randomizer v2\\content\\Map\\MainField\\",
        ["A-", "B-", "C-", "D-", "E-", "F-", "G-", "H-", "I-", "J-"],
        ["1", "2", "3", "4", "5", "6", "7", "8"],
    )
...
if swordTrial:
    ...
    randomizeEnemies(
        "Enemy Randomizer v2\\aoc\\0010\\Map\\AocField\\", ["A-", "B-"], ["1", "2", "3"]
    )

if shrines:
    print("Randomizing Shrine enemies...")
    randomizeEnemiesPack(
        "Enemy Randomizer v2\\content\\Pack\\",
        "Map/CDungeon/",
        ["Dungeon" + str(i)[1:4] for i in range(1000, 1120)],
    )

if dlcshrines:
    print("Randomizing DLC Shrines enemies...")
    randomizeEnemiesPack(
        "Enemy Randomizer v2\\aoc\\0010\\Pack\\",
        "Map/CDungeon/",
        ["Dungeon" + str(i)[1:4] for i in range(1120, 1136)],
    )
...
if beasts:
    ...
    randomizeEnemiesPack(
        ...
        ["RemainsWater", "RemainsFire", "RemainsElectric", "RemainsWind", "FinalTrial"],
    )
